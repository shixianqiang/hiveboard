cmd_arch/unicore/lib/strncpy_from_user.o := unicore32-linux-gcc -Wp,-MD,arch/unicore/lib/.strncpy_from_user.o.d  -nostdinc -isystem /usr/unicore/gnu-toolchain-unicore/uc4-1.0-beta-hard-RHELAS5/lib/gcc/unicore32-linux/4.4.2/include -Iinclude  -I/home/daniel/linux-2.6.32.9_hiveboard/arch/unicore/include -include include/linux/autoconf.h -D__KERNEL__ -mlittle-endian -Iarch/unicore/mach-sep0611/include -D__ASSEMBLY__ -msoft-float       -c -o arch/unicore/lib/strncpy_from_user.o arch/unicore/lib/strncpy_from_user.S

deps_arch/unicore/lib/strncpy_from_user.o := \
  arch/unicore/lib/strncpy_from_user.S \
...
arch/unicore/lib/strncpy_from_user.o: $(deps_arch/unicore/lib/strncpy_from_user.o)
