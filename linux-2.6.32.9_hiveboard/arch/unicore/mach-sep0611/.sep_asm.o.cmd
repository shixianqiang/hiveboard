cmd_arch/unicore/mach-sep0611/sep_asm.o := unicore32-linux-gcc -Wp,-MD,arch/unicore/mach-sep0611/.sep_asm.o.d  -nostdinc -isystem /usr/unicore/gnu-toolchain-unicore/uc4-1.0-beta-hard-RHELAS5/lib/gcc/unicore32-linux/4.4.2/include -Iinclude  -I/home/daniel/linux-2.6.32.9_hiveboard/arch/unicore/include -include include/linux/autoconf.h -D__KERNEL__ -mlittle-endian -Iarch/unicore/mach-sep0611/include -D__ASSEMBLY__ -msoft-float       -c -o arch/unicore/mach-sep0611/sep_asm.o arch/unicore/mach-sep0611/sep_asm.S

deps_arch/unicore/mach-sep0611/sep_asm.o := \
  arch/unicore/mach-sep0611/sep_asm.S \
...
arch/unicore/mach-sep0611/sep_asm.o: $(deps_arch/unicore/mach-sep0611/sep_asm.o)
