...
#endif
    sep0611_gpio_cfgpin(SEP0611_LCD_BL_CTRL, SEP0611_GPIO_IO);   /* GPIO */
    sep0611_gpio_dirpin(SEP0611_LCD_BL_CTRL, SEP0611_GPIO_OUT);  /* output */
    sep0611_gpio_setpin(SEP0611_LCD_BL_CTRL, GPIO_LOW);
	}
}
...
{
	printk(KERN_INFO "LCD AT070TN90  will be initialized\n");
