/*
 * arch/unicore/cpu/unicore32/SDIO.c
...
#include "SDIO1.h"
#include "SDIO1_protocol.h"
#include "sdio_DMAC.h"

#define SECTOR_SIZE 0x200
static int *sdhc_flag = (int *)(0x32010000);
...
void sd2ddr()
{
	...
	ReadMultiSD(0, 1000, 0x40500000); //uboot from SD to DDR
//	ReadMultiSD(10000, 6000, 0x40008000); //linux from SD to DDR
//	ReadMultiSD(20000, 30000, 0x41008000); //rootfs from SD to DDR
}

inline U16 one_SDIO1_initial(void)
{
    U32 resp;
    U32 temp;
    U16 rca_return;
    ...
    *(RP)SDIO1_CMD     =  SDIO1_CMD_START            | SDIO1_CMD_UPDATE_CLK_REG_ONLY(1) | SDIO1_CMD_CARD_NUM (0) \
    ...
    while(*(RP)SDIO1_CMD & 0x80000000);          	//wait the command taken by CIU
    ...
    *(RP)SDIO1_CMD     =  SDIO1_CMD_START             | SDIO1_CMD_UPDATE_CLK_REG_ONLY(0) | SDIO1_CMD_CARD_NUM (0) \
    ...
    while((*(RP)SDIO1_RINTSTS & 0x4) != 0x4);
...
inline void update_clock_region(void)
{
    U32 temp;
...
inline void SDIO1_toggle_standby_transfer(U16 rca)
{
    U32 rca_temp = rca <<16;
    U32 resp;
...
inline void SDIO1_width_switch(U16 rca, U16 width)
{
    U32 temp;
...
inline void ReadMultiSD(U32 sector_start, S32 nob, U32 ram_start)
{
	U32 temp;
    U32 nob_temp;
    U32 word_len;
