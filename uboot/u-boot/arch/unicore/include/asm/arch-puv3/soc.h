/*
 * linux/arch/unicore/mach-v8/include/mach/PKUnity.h
 *
...
#define __REG(PhAdd)    *((volatile unsigned long *)(PhAdd)) 
...
#include <asm/arch/regs-dmac.h>
#define PKUNITY_UMAL_BASE		0xC0300000 /* AHB-5 */
#include <asm/arch/regs-umal.h>
int	umal_initialize(bd_t *bis);
...
#include <asm/arch/regs-unigfx.h>
