/*
 *  linux/include/asm-unicore/memory.h
 *
 ...
 */
#ifndef __ASM_UNICORE_MEMORY_H
#define __ASM_UNICORE_MEMORY_H
 ...
 *  PHYS_TO_NID is used by the UNICORE kernel/setup.c
 */
