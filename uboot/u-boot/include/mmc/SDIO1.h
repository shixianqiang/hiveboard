...
static U16     one_SDIO1_initial(void);
static void    update_clock_region(void);
static void    SDIO1_toggle_standby_transfer(U16 rca);
static void    SDIO1_width_switch(U16 rca, U16 width);
static U32     cmd_response_resp(U32 cmdarg, U32 index);
extern void    ReadMMC(U32 sector_start, S32 nob, U32 ram_start);
